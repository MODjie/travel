		...
		<section id="intro" style="background-image: url(images/testimonials/Testimonials.jpg);">
			...
			<div class="intro-content">
				...
				<ul class="intro-social">
					<li>
						<a href="personal.html" title="我的主页" style="color: #cc005f;"><i class="fa icon-home"></i></a>
					</li>
					<li>
						<a href="userinfo.html" title="个人信息"><i class="fa icon-user-md"></i></a>
					</li>
					<li>
		...
		<section id="portfolio">
			...
			<div class="row section-intro">
				<div class="col-twelve">
					...
					<h5>2018年1月3日</h5>
					<h1>亲爱的<span>有梦想的码农</span></h1>

					<p class="lead">您于2017年12月24日与“小码游”结下了深厚的友谊，15天的风风雨雨，我们一起携手走过。我们感受您的喜怒哀乐，陪您走过大江南北，见识过各种各样的风土人情。在未来的日子里，我们会永远陪伴在您的身旁。</p>
				...
				<div class="col-twelve">
					...
					<div id="folio-wrapper" class="block-1-2 block-mob-full stack">
						...
						<div class="bgrid folio-item">
							<div class="item-wrap">
								<img src="images/portfolio/liberty.jpg" alt="见闻">
								<a href="exprienceList.html" class="overlay">
						...
						<div class="bgrid folio-item">
							<div class="item-wrap">
								<img src="images/portfolio/shutterbug.jpg" alt="游记">
								<a href="exprienceList.html" class="overlay">
									<div class="folio-item-table">
										<div class="folio-item-cell">
						...
						<div class="bgrid folio-item">
							<div class="item-wrap">
								<img src="images/portfolio/clouds.jpg" alt="风景">
								<a href="exprienceList.html" class="overlay">
									<div class="folio-item-table">
										<div class="folio-item-cell">
						...
						<div class="bgrid folio-item">
							<div class="item-wrap">
								<img src="images/portfolio/beetle.jpg" alt="攻略">
								<a href="exprienceList.html" class="overlay">
									<div class="folio-item-table">
										<div class="folio-item-cell">
						...
						<div class="bgrid folio-item">
							<div class="item-wrap">
								<img src="images/portfolio/lighthouse.jpg" alt="动态">
								<a href="exprienceList.html" class="overlay">
									<div class="folio-item-table">
										<div class="folio-item-cell">
						...
						<div class="bgrid folio-item">
							<div class="item-wrap">
								<img src="images/portfolio/salad.jpg" alt="美食">
								<a href="exprienceList.html" class="overlay">
									<div class="folio-item-table">
										<div class="folio-item-cell">
